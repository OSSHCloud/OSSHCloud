...
export class PeopleService {
  constructor(
    ...
    private readonly mainRepository: Repository<People>,
    @InjectRepository(PeopleHistory)
    private readonly historyRepositry: Repository<PeopleHistory>,
  ) {}
